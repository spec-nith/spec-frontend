...
export default class ImageContainer extends Component {
    ...
    Image = ImageBox.map((element,index)=>{
        return(
            <div className="gallery-item" style={{ backgroundImage: `url(${element.img})` }} onClick={()=>this.showImage(element.img,index)} >
    ...
    render() {
        return (
            ...
            {this.state.FullImageCard && <div id="overlay">
                ...
                <div id="nextButton" className={this.state.currentIndex==(ImageBox.length-1) ? "gallery-disabled":''} onClick={()=>this.showNext(this.state.currentIndex)}><FontAwesomeIcon icon={faChevronRight}  /></div>
