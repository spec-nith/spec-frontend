...
export default function Example() {
  useEffect(()=>{
    ...
    const notes = document.querySelectorAll(".bongoNote");
    ...
    const music = { note: s(".bongoMusic .bongoNote") };
    const cat = {
        pawRight: {
            up: s(".paw-right .bongoUp"),
            down: s(".paw-right .bongoDown"),
        },
        pawLeft: {
            up: s(".paw-left .bongoUp"),
            down: s(".paw-left .bongoDown"),
        },
    };
  ...
  return (
    <React.Fragment>
    <div className="overflow-hidden bg-transparent flex justify-around items-center w-full lg:flex-row flex-col-reverse">
      <div className="max-w-7xl">
          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                {/* <span className="inline HeroText">TEAM </span><br/> */}
                <span className="text-indigo-600 inline HeroText">Team SPEC</span>
              </h1>
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
                  <Link
                    to="/gallery"
                    className="flex w-full items-center justify-center rounded-md border border-transparent btn-gradient px-8 py-3 text-base font-medium text-white hover:scale-105 md:py-4 md:px-10 md:text-lg"
                  >
                    Gallery
                  </Link>
                </div>
                <div className="mt-3 sm:mt-0 sm:ml-3 btn-gradient rounded-md hover:scale-105" style={{padding: "2px"}}>
                  <Link
                    to="/team"
        ...
        <div className='heroCircle lg:w-[40rem] lg:h-[40rem] md:h-[30rem] h-[20rem] md:w-[30rem] w-[20rem]'>
            <div className="bongoContainer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 783.55 354.91">
                <g id="bongo-cat">
                  <g className="bongoHead">
                    ...
                    <g className="bongoHeadphone bongoHeadphone-right">
                      <g className="bongoSpeaker">
                      ...
                      <path className="bongoBand" d="M515,40.6c-15.9-4.6-57-14.1-104,2.3a166.9,166.9,0,0,0-60.9,37.3"></path>
                    </g>
                  </g>
                  <g className="bongoMusic bongoMusic-right">
                    <g className="bongoNote">
                      <g>
                  ...
                  <g className="paw paw-right">
                    <path className="bongoDown" d="M289.1,181.7c-12.1,9.8-20.6,20.7-20.7,32.1-.2,9,3.8,20.4,13.3,25.2s20.1.6,29.6-3.4c13.4-5.7,23.9-14.6,29.4-21.5"></path>
                    <g className="bongoUp">
                      <path d="M327.3,170c-.4-1.4-6.3-18.8-23.5-23.5-.8-.2-18.6-4.7-28.9,6.3-8.4,9.1-6,22.5-4.6,30.2a54.3,54.3,0,0,0,8.1,19.9"></path>
                      <g className="bongoPads">
                  ...
                  <g className="paw paw-left">
                    ...
                    <path className="bongoDown" d="M534.1,231.4c-19.7,6-32.9,18.4-34.2,29.1a30.1,30.1,0,0,0,1.7,14.1,24.8,24.8,0,0,0,6.1,8.8c6,5.1,16.8,4,38-3.9a288.7,288.7,0,0,0,46.5-22.1"></path>
                  </g>
                  <g className="bongoHeadphone bongoHeadphone-left">
                    <g className="bongoSpeaker">
                    ...
                    <path className="bongoBand" d="M638.9,157.7c-4-16.8-25.9-61.9-75.3-95.3A155.5,155.5,0,0,0,515,40.6"></path>
                  </g>
                  <g className="bongoMusic bongoMusic-left">
                    <g className="bongoNote">
                      <g>
