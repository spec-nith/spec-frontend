  ...
  <footer className="pl-4 divide-y bg-black text-white">
    <div className="container flex flex-col justify-around py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
      <div className="flex-1 lg:w-1/3 flex flex-col justify-center items-center">
        ...
        <a href="/">
          <span className="text-center text-2xl font-monty">SEARCH PLAN ENGAGE CREATE</span>
        </a>
      </div>
      <div className="flex-1">
        <h1 className="text-center text-4xl pr-4">
          Get in Touch
        </h1>
        <div className="justify-center mt-6">
          <div className="rounded-md">
            <div className="max-w-screen-xl pr-8 grid gap-x-24 gap-y-8 grid-cols-1 mx-auto">
              <textarea className="w-full h-32 content-theme  mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" placeholder="Enter your query" aria-label="Enter your query" />
              
              <button className="p-3 border-2 border-gray-900 rounded-md text-base hover:bg-gray-200 hover:border-gray-200 cursor-pointer hover:text-black ">Send</button>
    ...
    <a className="transform hover:-translate-y-1 duration-300 text-xl" href="mailto:spec@nith.ac.in"><FontAwesomeIcon icon={faEnvelope} className="mr-2" />
							spec@nith.ac.in</a>
